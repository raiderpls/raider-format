...
function s.filter(c,e,tp)
	return c:IsSetCard(0x1e01) and c:IsCanBeSpecialSummoned(e, 0, tp, false, false)
end
...
function s.activate(e,tp,eg,ep,ev,re,r,rp)
	...
	local group = Duel.SelectMatchingCard(tp, s.filter, tp, LOCATION_DECK, 0, 1, 1, nil, e, tp)
